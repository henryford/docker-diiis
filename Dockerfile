...
RUN ["dotnet", "restore", "--disable-parallel", "--packages", "/dnet/packages"]
RUN ["dotnet", "build", "-c", "Release", "--no-restore", "--nologo", "-o", "/diiis", "-v", "m", "-NoWarn:SYSLIB0011", "-NoWarn:SYSLIB0003", "-NoWarn:CS0108", "-NoWarn:CS0414", "-NoWarn:CS0169", "-NoWarn:CS0219", "-NoWarn:CS0649", "-NoWarn:CS0105", "/diiistmp/src/Blizzless-D3.sln"]
